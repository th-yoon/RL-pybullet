...
#from .pendulum_robot import InvertedPendulum, InvertedPendulumSwingup, InvertedDoublePendulum
from .inverted_pendulum import InvertedPendulum
from .inverted_pendulum_swingup import InvertedPendulumSwingup
...
class InvertedPendulumBulletEnv(MJCFBaseBulletEnv):
    ...
    def step(self, a, is_pid=False):
        self.robot.apply_action(a, is_pid)
...
class InvertedDoublePendulumBulletEnv(MJCFBaseBulletEnv):
    ...
    def step(self, a):
        ...
        self.rewards = [float(alive_bonus),
                        float(-dist_penalty), float(-vel_penalty)]
        self.HUD(state, a, done)
        return state, sum(self.rewards), done, {}
